...
public class Game6x6 extends AppCompatActivity implements View.OnClickListener {
    int n = 6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        clockVoice=MediaPlayer.create(Game6x6.this,R.raw.music);//novo
        ...
        buttonbtm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Game6x6.this,First_Page.class));
            }
        });
    }
    ...
    private void Time() {                //novo
        countDownTimer = new CountDownTimer(sec, 1000) {
            ...
            public void onFinish() {
                player1Turn = !player1Turn;
                if (player1Turn) {
                    Toast.makeText(Game6x6.this, pl1 + "'s turn.", Toast.LENGTH_SHORT).show();
                    textViewPlayer1.setTextColor(Color.parseColor("blue"));
                    textViewPlayer2.setTextColor(Color.parseColor("gray"));
                }
                else {
                    Toast.makeText(Game6x6.this, pl2 + "'s turn.", Toast.LENGTH_SHORT).show();
